...
// Two mm play support speaker and line out
#ifndef ENABLE_DUALMONO
#define ENABLE_DUALMONO 0
#endif
#ifndef ENABLE_DUAL_OUTPUT
#define ENABLE_DUAL_OUTPUT 1
#endif
...
// MStar Android Patch Begin
// Two mm play support speaker and line out
#if (ENABLE_DUALMONO || ENABLE_DUAL_OUTPUT)
    AUDIO_STREAM_MUSIC_SUB        = 10,
#endif
// MStar Android Patch End
...
typedef enum {
    ...
    AUDIO_SOURCE_A2DP                = 10,
    AUDIO_SOURCE_CAPTURE_DEVICE0     = 11,
    AUDIO_SOURCE_CAPTURE_DEVICE1     = 12,
    // MStar Android Patch End
    AUDIO_SOURCE_CNT,
...
// Two mm play support speaker and line out
    ...
    AUDIO_DEVICE_OUT_LINE_OUT                   = 0x10000,
#endif
    AUDIO_DEVICE_OUT_BLUETOOTH_SPK              = 0x20000,
// MStar Android Patch End
...
// Two mm play support speaker and line out
#if ENABLE_DUAL_OUTPUT
                                 AUDIO_DEVICE_OUT_LINE_OUT |
#endif
                                 AUDIO_DEVICE_OUT_BLUETOOTH_SPK |
// MStar Android Patch End
    ...
    // MStar Android Patch Begin
    AUDIO_DEVICE_IN_BLUETOOTH_MIC         = AUDIO_DEVICE_BIT_IN | 0x2000,
    AUDIO_DEVICE_IN_BLUETOOTH_A2DP        = AUDIO_DEVICE_BIT_IN | 0x4000,
    AUDIO_DEVICE_IN_CAPTURE_DEVICE0       = AUDIO_DEVICE_BIT_IN | 0x8000,
    AUDIO_DEVICE_IN_CAPTURE_DEVICE1       = AUDIO_DEVICE_BIT_IN | 0x10000,
    // MStar Android Patch End
    ...
    AUDIO_DEVICE_IN_ALL     = (AUDIO_DEVICE_IN_COMMUNICATION |
                               ...
                               // MStar Android Patch Begin
                               AUDIO_DEVICE_IN_BLUETOOTH_MIC |
                               AUDIO_DEVICE_IN_CAPTURE_DEVICE0 |
                               AUDIO_DEVICE_IN_CAPTURE_DEVICE1 |
...
// MStar Android Patch Begin
// bluetooth mic throug sco or hid routing from broadcom
static inline bool audio_is_bluetooth_mic_device(audio_devices_t device)
{
    device &= ~AUDIO_DEVICE_BIT_IN;
    if ((popcount(device) == 1) && (device & (AUDIO_DEVICE_IN_BLUETOOTH_MIC)))
        return true;
    else
        return false;
}
