...
// Fix logcat can't handle native library preload issue.
// we modify logwrapper so that it can read env from argument
const char *env[] = {"LD_PRELOAD=/mslib/preloadable_libiconv.so", NULL};
int dfpath=0;
int haspath=0;
char* tempenv=NULL;
